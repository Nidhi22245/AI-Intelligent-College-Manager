...
def process_button(d, p, sec):
    ...
    tk.Button(
        ...
        font=('Consolas'),
        width=10,
        command=details.destroy,fg="#104e8b",bg="#FCFCFC"
    ).pack(pady=10)
...
def student_tt_frame(tt, sec):
    ...
    recess = tk.Label(
        recess_frame,
        text='B\n\nR\n\nE\n\nA\n\nK',
        font=('Consolas', 18, 'italic'),fg="#104e8b",bg="#FCFCFC",
        width=3,
        bd=0,
        relief='sunken'
    )
...
if __name__ == "__main__":
    ...
    tt.configure(bg="#F0F8FF")


    student_tt_frame(tt, section)

    sec_select_f = tk.Frame(tt, pady=15,bg="#FCFCFC")
    sec_select_f.pack()

    tk.Label(
        sec_select_f,
        text='Select section:  ',
        font=('Consolas', 12),bg="white",fg="#104e8b"
    ).pack(side=tk.LEFT)
